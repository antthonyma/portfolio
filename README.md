[![Banner](https://github.com/antthonyma/portfolio/blob/main/assets/ele/repo_banner.png?raw=true)](https://github.com/antthonyma/portfolio)
...
### Theme Colors
Update CSS variables in `assets/styles.css`:
```css
:root {
...
Customize the typing roles in `assets/script.js`:
```javascript
const roles = [
    'CS Student',
    'Web Developer', 
...
<details>
<summary>Adding New Content</summary>
...
### Projects Section
Add new projects in the projects container:
```html
